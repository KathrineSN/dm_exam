...
# saving jags output
# true mu
saveRDS(true_mu_a_rew, "jags_output_100t_232s_50i_no_scale/true_mu_a_rew.rds")
saveRDS(true_mu_a_pun, "jags_output_100t_232s_50i_no_scale/true_mu_a_pun.rds")
saveRDS(true_mu_K, "jags_output_100t_232s_50i_no_scale/true_mu_K.rds")
saveRDS(true_mu_theta, "jags_output_100t_232s_50i_no_scale/true_mu_theta.rds")
saveRDS(true_mu_omega_f, "jags_output_100t_232s_50i_no_scale/true_mu_omega_f.rds")
saveRDS(true_mu_omega_p, "jags_output_100t_232s_50i_no_scale/true_mu_omega_p.rds")
#infer mu
saveRDS(infer_mu_a_rew, "jags_output_100t_232s_50i_no_scale/infer_mu_a_rew.rds")
saveRDS(infer_mu_a_pun, "jags_output_100t_232s_50i_no_scale/infer_mu_a_pun.rds")
saveRDS(infer_mu_K, "jags_output_100t_232s_50i_no_scale/infer_mu_K.rds")
saveRDS(infer_mu_theta, "jags_output_100t_232s_50i_no_scale/infer_mu_theta.rds")
saveRDS(infer_mu_omega_f, "jags_output_100t_232s_50i_no_scale/infer_mu_omega_f.rds")
saveRDS(infer_mu_omega_p, "jags_output_100t_232s_50i_no_scale/infer_mu_omega_p.rds")
#true lambda
saveRDS(true_lambda_a_rew, "jags_output_100t_232s_50i_no_scale/true_lambda_a_rew.rds")
saveRDS(true_lambda_a_pun, "jags_output_100t_232s_50i_no_scale/true_lambda_a_pun.rds")
saveRDS(true_lambda_K, "jags_output_100t_232s_50i_no_scale/true_lambda_K.rds")
saveRDS(true_lambda_theta, "jags_output_100t_232s_50i_no_scale/true_lambda_theta.rds")
saveRDS(true_lambda_omega_f, "jags_output_100t_232s_50i_no_scale/true_lambda_omega_f.rds")
saveRDS(true_lambda_omega_p, "jags_output_100t_232s_50i_no_scale/true_lambda_omega_p.rds")
#infer lambda
saveRDS(infer_lambda_a_rew, "jags_output_100t_232s_50i_no_scale/infer_lambda_a_rew.rds")
saveRDS(infer_lambda_a_pun, "jags_output_100t_232s_50i_no_scale/infer_lambda_a_pun.rds")
saveRDS(infer_lambda_K, "jags_output_100t_232s_50i_no_scale/infer_lambda_K.rds")
saveRDS(infer_lambda_theta, "jags_output_100t_232s_50i_no_scale/infer_lambda_theta.rds")
saveRDS(infer_lambda_omega_f, "jags_output_100t_232s_50i_no_scale/infer_lambda_omega_f.rds")
saveRDS(infer_lambda_omega_p, "jags_output_100t_232s_50i_no_scale/infer_lambda_omega_p.rds")
...
ggsave("jags_output_100t_232s_50i_no_scale/hier_ORL_rec_100t_232s_50i_no_scale_mu.png", width = 2000, height = 1150, units = 'px', dpi = 150) ##### CHANGE HERE
getwd()
...
ggarrange(pl1, pl2, pl3, pl4, pl5, pl6)
ggsave("jags_output_100t_232s_50i_no_scale/hier_ORL_rec_100t_232s_50i_no_scale_lambda.png", width = 2000, height = 1150, units = 'px', dpi = 150) ##### CHANGE HERE
