...
Here, we run the parameter recovery wiht 95, 100 and 150 trials to see if there is a notable difference.
number of trials is updated above before the payoff structure is built
...
for (i in 1:niterations) {
  ...
  source('dm_exam/data_preprocessing/hier_PVL/hier_PVL_sim.R')
  ...
  samples <- jags.parallel(data, inits=NULL, params,
                           model.file ="work/dm_exam/data_preprocessing/hier_PVL/hier_PVL.txt",
...
saveRDS(true_mu_w, "jags_output_95t_247s_100i/true_mu_w.rds")
saveRDS(true_mu_A, "jags_output_95t_247s_100i/true_mu_A_risk.rds")
saveRDS(true_mu_theta, "jags_output_95t_247s_100i/true_mu_theta.rds")
saveRDS(true_mu_a, "jags_output_95t_247s_100i/true_mu_alpha.rds")

saveRDS(infer_mu_w, "jags_output_95t_247s_100i/infer_mu_w.rds")
saveRDS(infer_mu_A, "jags_output_95t_247s_100i/infer_mu_A_risk.rds")
saveRDS(infer_mu_theta, "jags_output_95t_247s_100i/infer_mu_theta.rds")
saveRDS(infer_mu_a, "jags_output_95t_247s_100i/infer_mu_alpha.rds")

saveRDS(true_lambda_w, "jags_output_95t_247s_100i/true_lambda_w.rds")
saveRDS(true_lambda_A, "jags_output_95t_247s_100i/true_lambda_A_risk.rds")
saveRDS(true_lambda_theta, "jags_output_95t_247s_100i/true_lambda_theta.rds")
saveRDS(true_lambda_a, "jags_output_95t_247s_100i/true_lambda_alpha.rds")

saveRDS(infer_lambda_w, "jags_output_95t_247s_100i/infer_lambda_w.rds")
saveRDS(infer_lambda_A, "jags_output_95t_247s_100i/infer_lambda_A_risk.rds")
saveRDS(infer_lambda_theta, "jags_output_95t_247s_100i/infer_lambda_theta.rds")
saveRDS(infer_lambda_a, "jags_output_95t_247s_100i/infer_lambda_alpha.rds")
```
...
ggsave("jags_output_95t_247s_100i/hier_PVL_rec_95t_247s_100i_mu.png", width = 2000, height = 1150, units = 'px', dpi = 150) ##### CHANGE HERE
...
ggarrange(pl1, pl2, pl3, pl4)
ggsave("jags_output_95t_247s_100i/hier_PVL_rec_95t_247s_100i_lambda.png", width = 2000, height = 1150, units = 'px', dpi = 150)
...
ggarrange(pl1, pl2, pl3, pl4)
ggsave("jags_output_95t_247s_100i/hier_PVL_rec_95t_247s_100i_lambda_sd.png", width = 2000, height = 1150, units = 'px', dpi = 150)
