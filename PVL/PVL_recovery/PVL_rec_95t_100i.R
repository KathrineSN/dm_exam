...
saveRDS(infer_A, file = "jags_output_95t_100i/infer_A_risk.rds")
saveRDS(infer_a, file = "jags_output_95t_100i/infer_alpha.rds")
saveRDS(infer_w, file = "jags_output_95t_100i/infer_w.rds")
saveRDS(infer_theta, file = "jags_output_95t_100i/infer_theta.rds")

saveRDS(true_A, file = "jags_output_95t_100i/true_A_risk.rds")
saveRDS(true_a, file = "jags_output_95t_100i/true_alpha.rds")
saveRDS(true_w, file = "jags_output_95t_100i/true_w.rds")
...
ggsave("jags_output_95t_100i/PVL_rec_95t_100i_all_params.png", width = 2000, height = 1150, units = 'px', dpi = 150)

ggsave("jags_output_95t_100i/PVL_rec_95t_100i_w.png",pl1, width = 2000, height = 1150, units = 'px', dpi = 150)
ggsave("jags_output_95t_100i/PVL_rec_95t_100i_A_risk.png",pl2, width = 2000, height = 1150, units = 'px', dpi = 150)
ggsave("jags_output_95t_100i/PVL_rec_95t_100i_alpha.png",pl3, width = 2000, height = 1150, units = 'px', dpi = 150)
ggsave("jags_output_95t_100i/PVL_rec_95t_100i_theta.png",pl4, width = 2000, height = 1150, units = 'px', dpi = 150)
