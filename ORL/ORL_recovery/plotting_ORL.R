...
infer_a_rew <- readRDS("jags_output_100t_50i_no_theta/infer_a_rew.rds")
infer_a_pun <- readRDS("jags_output_100t_50i_no_theta/infer_a_pun.rds")
infer_K <- readRDS("jags_output_100t_50i_no_theta/infer_K.rds")
infer_omega_f <- readRDS("jags_output_100t_50i_no_theta/infer_omega_f.rds")
infer_omega_p <- readRDS("jags_output_100t_50i_no_theta/infer_omega_p.rds")
infer_theta <- readRDS("jags_output_100t_50i_no_theta/infer_theta.rds")

true_a_rew <- readRDS("jags_output_100t_50i_no_theta/true_a_rew.rds")
true_a_pun <- readRDS("jags_output_100t_50i_no_theta/true_a_pun.rds")
true_K <- readRDS("jags_output_100t_50i_no_theta/true_K.rds")
true_omega_f <- readRDS("jags_output_100t_50i_no_theta/true_omega_f.rds")
true_omega_p <- readRDS("jags_output_100t_50i_no_theta/true_omega_p.rds")
true_theta <- readRDS("jags_output_100t_50i_no_theta/true_theta.rds")
...
#ggsave("plots_all_params_R_sq/ORL_rec_100t_50i_no_theta_all_params.png", width = 2200, height = 1150, units = 'px', dpi = 150)
