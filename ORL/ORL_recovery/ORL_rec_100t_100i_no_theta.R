...
saveRDS(infer_a_rew, file = "jags_output_100t_100i_no_theta/infer_a_rew.rds")
saveRDS(infer_a_pun, file = "jags_output_100t_100i_no_theta/infer_a_pun.rds")
saveRDS(infer_K, file = "jags_output_100t_100i_no_theta/infer_K.rds")
saveRDS(infer_omega_f, file = "jags_output_100t_100i_no_theta/infer_omega_f.rds")
saveRDS(infer_omega_p, file = "jags_output_100t_100i_no_theta/infer_omega_p.rds")

saveRDS(true_a_rew, file = "jags_output_100t_100i_no_theta/true_a_rew.rds")
saveRDS(true_a_pun, file = "jags_output_100t_100i_no_theta/true_a_pun.rds")
saveRDS(true_K, file = "jags_output_100t_100i_no_theta/true_K.rds")
saveRDS(true_omega_f, file = "jags_output_100t_100i_no_theta/true_omega_f.rds")
saveRDS(true_omega_p, file = "jags_output_100t_100i_no_theta/true_omega_p.rds")
...
ggsave("jags_output_100t_100i_no_theta/ORL_rec_all_params.png", width = 2000, height = 1150, units = 'px', dpi = 150)
