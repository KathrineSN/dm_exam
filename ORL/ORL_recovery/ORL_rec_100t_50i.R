...
saveRDS(infer_a_rew, file = "jags_output_100t_50i/infer_a_rew.rds")
saveRDS(infer_a_pun, file = "jags_output_100t_50i/infer_a_pun.rds")
saveRDS(infer_K, file = "jags_output_100t_50i/infer_K.rds")
saveRDS(infer_theta, file = "jags_output_100t_50i/infer_theta.rds")
saveRDS(infer_omega_f, file = "jags_output_100t_50i/infer_omega_f.rds")
saveRDS(infer_omega_p, file = "jags_output_100t_50i/infer_omega_p.rds")

saveRDS(true_a_rew, file = "jags_output_100t_50i/true_a_rew.rds")
saveRDS(true_a_pun, file = "jags_output_100t_50i/true_a_pun.rds")
saveRDS(true_K, file = "jags_output_100t_50i/true_K.rds")
saveRDS(true_theta, file = "jags_output_100t_50i/true_theta.rds")
saveRDS(true_omega_f, file = "jags_output_100t_50i/true_omega_f.rds")
saveRDS(true_omega_p, file = "jags_output_100t_50i/true_omega_p.rds")
...
ggsave("jags_output_100t_50i/ORL_rec_all_params.png", width = 2000, height = 1150, units = 'px', dpi = 150)

ggsave("jags_output_100t_50i/ORL_rec_a_rew.png", pl1)
ggsave("jags_output_100t_50i/ORL_rec_a_pun.png", pl2)
ggsave("jags_output_100t_50i/ORL_rec_K.png", pl3)
ggsave("jags_output_100t_50i/ORL_rec_theta.png", pl4)
ggsave("jags_output_100t_50i/ORL_rec_omega_f.png", pl5)
ggsave("jags_output_100t_50i/ORL_rec_omega_p.png", pl6)