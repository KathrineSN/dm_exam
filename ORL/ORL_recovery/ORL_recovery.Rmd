...
library('pacman')
pacman::p_load(hesim, extraDistr, R2jags, parallel, ggpubr, tidyverse)
...
saveRDS(infer_a_rew, file = "saved_jags_output/infer_a_rew.rds")
saveRDS(infer_a_pun, file = "saved_jags_output/infer_a_pun.rds")
saveRDS(infer_K, file = "saved_jags_output/infer_K.rds")
saveRDS(infer_theta, file = "saved_jags_output/infer_theta.rds")
saveRDS(infer_omega_f, file = "saved_jags_output/infer_omega_f.rds")
saveRDS(infer_omega_p, file = "saved_jags_output/infer_omega_p.rds")

saveRDS(true_a_rew, file = "saved_jags_output/true_a_rew.rds")
saveRDS(true_a_pun, file = "saved_jags_output/true_a_pun.rds")
saveRDS(true_K, file = "saved_jags_output/true_K.rds")
saveRDS(true_theta, file = "saved_jags_output/true_theta.rds")
saveRDS(true_omega_f, file = "saved_jags_output/true_omega_f.rds")
saveRDS(true_omega_p, file = "saved_jags_output/true_omega_p.rds")
...
<<<<<<< HEAD
ggsave("ORL_recov_a_rew.png", pl1)
ggsave("ORL_recov_a_pun.png", pl2)
ggsave("ORL_recov_K.png", pl3)
ggsave("ORL_recov_theta.png", pl4)
ggsave("ORL_recov_omega_f.png", pl5)
ggsave("ORL_recov_omega_p.png", pl6)
=======
ggsave("", pl1,)
